...
export default class Home extends Component {
  ...
  handleChange = (event) => {
    ...
    switch (name) {
      case "email":
        errors.email = value != "admin" ? "Username is not valid" : "";
        break;
      case "password":
        errors.password = value != "admin" ? "Password is not valid!" : "";
        break;
